...
/*
 * SPC58NExx drivers configuration.
...
#define SPC5_CGM_SC_DC3_DIV_VALUE           ${conf.instance.initialization_settings.cgm_settings.sc_dc3_divider.value[0]}
#define SPC5_CGM_SC_DC4_DIV_VALUE           ${conf.instance.initialization_settings.cgm_settings.sc_dc4_divider.value[0]}
...
#define SPC5_CGM_AC8_SC_BITS                SPC5_CGM_SC_${conf.instance.initialization_settings.cgm_settings.ac8_clock_source.value[0]}
#define SPC5_CGM_AC8_DC0_DIV_VALUE          ${conf.instance.initialization_settings.cgm_settings.ac8_dc0_divider.value[0]}
#define SPC5_CGM_AC9_SC_BITS                SPC5_CGM_SC_${conf.instance.initialization_settings.cgm_settings.ac9_clock_source.value[0]}
#define SPC5_CGM_AC9_DC0_DIV_VALUE          ${conf.instance.initialization_settings.cgm_settings.ac9_dc0_divider.value[0]}
#define SPC5_CGM_AC11_SC_BITS               SPC5_CGM_SC_${conf.instance.initialization_settings.cgm_settings.ac11_clock_source.value[0]}
#define SPC5_CGM_AC11_DC0_DIV_VALUE         ${conf.instance.initialization_settings.cgm_settings.ac11_dc0_divider.value[0]}
#define SPC5_CGM_AC12_DC0_DIV_VALUE         ${conf.instance.initialization_settings.cgm_settings.ac12_dc0_divider.value[0]}
#define SPC5_CGM_AC12_DC0_DIV_FMT_VALUE     ${conf.instance.initialization_settings.cgm_settings.ac12_dc0_fmt.value[0]}
#define SPC5_CGM_AC12_DC1_DIV_VALUE         ${conf.instance.initialization_settings.cgm_settings.ac12_dc1_divider.value[0]}
#define SPC5_CGM_AC12_DC2_DIV_VALUE         ${conf.instance.initialization_settings.cgm_settings.ac12_dc2_divider.value[0]}
#define SPC5_CGM_AC12_DC3_DIV_VALUE         ${conf.instance.initialization_settings.cgm_settings.ac12_dc3_divider.value[0]}
#define SPC5_CGM_AC12_DC4_DIV_VALUE         ${conf.instance.initialization_settings.cgm_settings.ac12_dc4_divider.value[0]}
