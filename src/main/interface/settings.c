...
#else
    { "gyro_filter_q",              VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 160 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_filter_q) },
...
// PG_CONTROLRATE_PROFILES
    ...
    { "spa_rate_p",                 VAR_UINT8  | PROFILE_RATE_VALUE, .config.minmax = { 0, CONTROL_RATE_CONFIG_SPA_MAX}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, dynSetpP) },
    { "spa_rate_i",                 VAR_UINT8  | PROFILE_RATE_VALUE, .config.minmax = { 0, CONTROL_RATE_CONFIG_SPA_MAX}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, dynSetpI) },
    { "spa_rate_d",                 VAR_UINT8  | PROFILE_RATE_VALUE, .config.minmax = { 0, CONTROL_RATE_CONFIG_SPA_MAX}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, dynSetpD) },
