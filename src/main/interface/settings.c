...
// PG_PID_PROFILE
    ...
    { "ratio_gain_roll",            VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_ROLL].pidGain) },
    { "ratio_i_ratio_roll",         VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_ROLL].iRatio) },
    { "ratio_d_ratio_roll",         VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_ROLL].dRatio) },
    { "ratio_gain_pitch",           VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_PITCH].pidGain) },
    { "ratio_i_ratio_pitch",        VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_PITCH].iRatio) },
    { "ratio_d_ratio_pitch",        VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_PITCH].dRatio) },
    { "ratio_gain_yaw",             VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_YAW].pidGain) },
    { "ratio_i_ratio_yaw",          VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_YAW].iRatio) },
    { "ratio_d_ratio_yaw",          VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, ratio[PID_YAW].dRatio) },

    { "use_ratios",                 VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, useRatios) },
