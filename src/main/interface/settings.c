...
// PG_PID_PROFILE
    ...
    { "fo_iterm",                   VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 1, 10 }, PG_PID_PROFILE, offsetof(pidProfile_t, fo_iterm) },
    { "fo_dterm",                   VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 1, 10 }, PG_PID_PROFILE, offsetof(pidProfile_t, fo_dterm) },
