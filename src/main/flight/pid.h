...
typedef struct pidProfile_s {
    ...
    uint8_t iterm_relax_frequency;
    uint8_t iterm_relax_frequency_yaw;
    uint8_t iterm_relax_cutoff;             // This cutoff frequency specifies a low pass filter which predicts average response of the quad to setpoint
    uint8_t iterm_relax_cutoff_yaw;         // This cutoff frequency specifies a low pass filter which predicts average response of the quad to setpoint
