...
void quat2dcm(float	DCM[3][3])
{
#define q(x) fusionAhrs.quaternion.array[x]
...
//        FusionBiasInitialise(&fusionBias, 0.5f, dT); // stationary threshold = 0.5 degrees per second
//
...
//    debug[1] = deltaT;
//
//    // set the yaw component
//    if (useCOG)
//    {
//    	FusionAhrsSetYaw(&fusionAhrs, courseOverGround * 0.1f); // course over ground in dezi degrees
//    }
//
//    // Calibrate gyroscope
//    FusionVector3 uncalibratedGyroscope = {
//        .axis.x = (gyroAverage[X]), /* replace this value with actual gyroscope x axis measurement in lsb */
//        .axis.y = (gyroAverage[Y]), /* replace this value with actual gyroscope y axis measurement in lsb */
//        .axis.z = (gyroAverage[Z]), /* replace this value with actual gyroscope z axis measurement in lsb */
//    };
//    FusionVector3 calibratedGyroscope = FusionCalibrationInertial(uncalibratedGyroscope, FUSION_ROTATION_MATRIX_IDENTITY, gyroscopeSensitivity, FUSION_VECTOR3_ZERO);
//
//    // Calibrate accelerometer
//    FusionVector3 uncalibratedAccelerometer = {
//        .axis.x = accAverage[X], /* replace this value with actual accelerometer x axis measurement in lsb */
//        .axis.y = accAverage[Y], /* replace this value with actual accelerometer y axis measurement in lsb */
//        .axis.z = accAverage[Z], /* replace this value with actual accelerometer z axis measurement in lsb */
//    };
...
//    FusionAhrsUpdateWithoutMagnetometer(&fusionAhrs, calibratedGyroscope, calibratedAccelerometer, dT);
//
//    // Print Euler angles
...
//    quat2dcm(rMat);
//    //yawPitchRollToMatrixII(rMat, eulerAngles.array);
