...
void resetPidProfile(pidProfile_t *pidProfile)
{
    RESET_CONFIG(pidProfile_t, pidProfile,
                 ...
                 .pidSumLimit = PIDSUM_LIMIT_MAX, .pidSumLimitYaw = PIDSUM_LIMIT_YAW, .dterm_filter_type = FILTER_PT1, .itermWindupPointPercent = 50, .pidAtMinThrottle = PID_STABILISATION_ON, .levelAngleLimit = 45, .angleExpo = 10, .feedForwardTransition = 0, .setPointPTransition[ROLL] = 110, .setPointPTransition[PITCH] = 110, .setPointPTransition[YAW] = 130, .setPointITransition[ROLL] = 75, .setPointITransition[PITCH] = 75, .setPointITransition[YAW] = 45, .setPointDTransition[ROLL] = 110, .setPointDTransition[PITCH] = 110, .setPointDTransition[YAW] = 130, .feathered_pids = 100, .i_decay = 4, .errorBoost = 15, .errorBoostYaw = 40, .errorBoostLimit = 20, .errorBoostLimitYaw = 40, .yawRateAccelLimit = 0, .rateAccelLimit = 0, .itermThrottleThreshold = 350, .itermAcceleratorGain = 1000,
                 .crash_time = 500,                        // ms
                 .crash_delay = 0,                         // ms
