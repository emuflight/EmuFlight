...
// PG_GYRO_CONFIG
    ...
    { "adaptive_filter_crossfeed",  VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 100 },    PG_GYRO_CONFIG, offsetof(gyroConfig_t, adaptive_filter_crossfeed) },
    { "adaptive_filter_regularization",  VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 10000 },    PG_GYRO_CONFIG, offsetof(gyroConfig_t, adaptive_filter_regularization) },
