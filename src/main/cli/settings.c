...
// PG_GYRO_CONFIG
    ...
    { "gyro_abg_alpha_yaw",         VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, alphaYaw) },
...
// PG_CONTROLRATE_PROFILES
    ...
    { "tpa_rate_p",                 VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, CONTROL_RATE_CONFIG_TPA_MAX}, PG_CONTROL_RATE_PROFILES, offsetof(pidProfile_t, dynThr[0]) },
    { "tpa_rate_i",                 VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, CONTROL_RATE_CONFIG_TPA_MAX}, PG_CONTROL_RATE_PROFILES, offsetof(pidProfile_t, dynThr[1]) },
    { "tpa_rate_d",                 VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, CONTROL_RATE_CONFIG_TPA_MAX}, PG_CONTROL_RATE_PROFILES, offsetof(pidProfile_t, dynThr[2]) },
    { "tpa_breakpoint",             VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { PWM_PULSE_MIN, PWM_PULSE_MAX }, PG_CONTROL_RATE_PROFILES, offsetof(pidProfile_t, tpa_breakpoint) },
// rateDynamics
