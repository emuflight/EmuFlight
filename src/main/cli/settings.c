...
// PG_GYRO_CONFIG
    ...
    { "imuf_rate",                  VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_IMUF_RATE }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, imuf_rate) }, // this should be removed and automated such that your gyro rate determines this
