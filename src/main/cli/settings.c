...
// PG_GYRO_CONFIG
    ...
    { "imuf_w",                     VAR_UINT16 | MASTER_VALUE, .config.minmax = { 3, 500  }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, imuf_w) },
...
// PG_PID_PROFILE
    ...
    { "dynlpf2_debug",               VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,    1 },    PG_GYRO_CONFIG, offsetof(gyroConfig_t, dynlpf2_debug) },
#endif
    { "dterm_dynlpf2_fmin",                VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 1000 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_fmin) },
    { "dterm_dynlpf2_fmax",                VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 1000 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_fmax) },
    { "dterm_dynlpf2_gain",                VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  200 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_gain) },
    { "dterm_dynlpf2_fc_fc",               VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,   50 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_fc_fc) },
    { "dterm_dynlpf2_center_threshold",    VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  100 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_center_threshold) },
    { "dterm_dynlpf2_throttle_threshold",  VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  100 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_throttle_threshold) },
    { "dterm_dynlpf2_throttle_gain",       VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  200 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_throttle_gain) },
    { "dterm_dynlpf2_enable",              VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,    1 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_enable) },
    { "dterm_dynlpf2_type",                VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,    1 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_type) },
    { "dterm_dynlpf2_debug",               VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,    1 },    PG_PID_PROFILE, offsetof(pidProfile_t, dterm_dynlpf2_debug) },
#if defined(USE_BATTERY_VOLTAGE_SAG_COMPENSATION)
