...
// PG_GYRO_CONFIG
    ...
    { "gyro_abg_boost",             VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 2000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, abg_boost) },
    { "gyro_abg_half_life",         VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, abg_half_life) },
...
// PG_IMU_CONFIG
    ...
    { "lynch_roll_m1",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, roll[0]) },
    { "lynch_pitch_m1",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, pitch[0]) },
    { "lynch_yaw_m1",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, yaw[0]) },
    { "lynch_roll_m2",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, roll[1]) },
    { "lynch_pitch_m2",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, pitch[1]) },
    { "lynch_yaw_m2",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, yaw[1]) },
    { "lynch_roll_m3",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, roll[2]) },
    { "lynch_pitch_m3",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, pitch[2]) },
    { "lynch_yaw_m3",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, yaw[2]) },
    { "lynch_roll_m4",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, roll[3]) },
    { "lynch_pitch_m4",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, pitch[3]) },
    { "lynch_yaw_m4",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, yaw[3]) },
    { "lynch_roll_m5",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, roll[4]) },
    { "lynch_pitch_m5",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, pitch[4]) },
    { "lynch_yaw_m5",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, yaw[4]) },
    { "lynch_roll_m6",   VAR_INT8 | MASTER_VALUE, .config.minmax = { -180, 180 }, PG_IMU_CONFIG, offsetof(imuConfig_t, roll[5]) },
...
// PG_PID_PROFILE
    ...
    { "dyn_lpf_dterm_width",        VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_PID_PROFILE, offsetof(pidProfile_t, dyn_lpf_dterm_width) },
    ...
    { "axis_smooth_multiplier",     VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50 }, PG_PID_PROFILE, offsetof(pidProfile_t, axis_smooth_multiplier) },
