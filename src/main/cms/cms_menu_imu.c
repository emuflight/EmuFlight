...
static OSD_Entry cmsx_menuPidAdvancedEntries[] =
{
    ...
    { "I RELAX FREQ",      OME_UINT8, NULL, &(OSD_UINT8_t){ &itermRelaxCutoff,      0, 100, 1 }, 0 },
    { "I RELAX FREQ YAW",  OME_UINT8, NULL, &(OSD_UINT8_t){ &itermRelaxCutoffYaw,   0, 100, 1 }, 0 },
    { "I RELAX CUTOFF",    OME_UINT8, NULL, &(OSD_UINT8_t){ &itermRelaxThreshold,         10, 100, 1 }, 0 },
    { "I RELAX CUTOFF YAW",OME_UINT8, NULL, &(OSD_UINT8_t){ &itermRelaxThresholdYaw,      10, 100, 1 }, 0 },
