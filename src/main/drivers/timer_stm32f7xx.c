...
// Every physically possible timer/channel/pin/AF combination on this MCU package.
// Ported from Betaflight 4.5-maintenance drivers/stm32/timer_stm32f7xx.c. The `flags`
// argument (BF has none here) is TIM_USE_ANY on every entry: usage is decided per-board
// via config.h's TIMER_PIN_MAPPING, not by this table.
...
//PORTE
    ...
    DEF_TIM(TIM9, CH1,  PE5,  0, 0, 0),
    DEF_TIM(TIM9, CH2,  PE6,  0, 0, 0),

//PORTF
    DEF_TIM(TIM10, CH1, PF6,  0, 0, 0),
    DEF_TIM(TIM11, CH1, PF7,  0, 0, 0),
