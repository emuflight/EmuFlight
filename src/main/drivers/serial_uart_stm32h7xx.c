...
#ifdef USE_UART1
static DMA_RW_AXI volatile uint8_t uart1TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart1RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART2
static DMA_RW_AXI volatile uint8_t uart2TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart2RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART3
static DMA_RW_AXI volatile uint8_t uart3TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart3RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART4
static DMA_RW_AXI volatile uint8_t uart4TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart4RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART5
static DMA_RW_AXI volatile uint8_t uart5TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart5RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART6
static DMA_RW_AXI volatile uint8_t uart6TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart6RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART7
static DMA_RW_AXI volatile uint8_t uart7TxBuffer[UART_TX_BUFFER_SIZE];
static DMA_RW_AXI volatile uint8_t uart7RxBuffer[UART_RX_BUFFER_SIZE];
#endif
#ifdef USE_UART8
...
// TX output check: not needed for basic half-duplex; always report complete.
...
// TX monitoring: stub for bidirectional serial TX state checking.
...
FAST_IRQ_HANDLER void uartIrqHandler(uartPort_t *s)
{
    ...
    if (__HAL_UART_GET_IT(huart, UART_IT_RXNE) != RESET) {
        uint8_t rbyte = (uint8_t)(huart->Instance->RDR & 0xffU);
