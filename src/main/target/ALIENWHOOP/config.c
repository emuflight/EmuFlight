...
void targetConfiguration(void)
{
    ...
    featureSet(FEATURE_AIRMODE ^ FEATURE_RX_PARALLEL_PWM);
	...
	/* Classic Expo */
        ...
        controlRateConfig->dynThrP = 0; // tpa_rate off
        controlRateConfig->dynThrI = 0; // tpa_rate off
        controlRateConfig->dynThrD = 0; // tpa_rate off
