...
#if defined(EF_VARIANT_KAKUTEF7MINIV2)
#define USBD_PRODUCT_STRING "KAKUTEF7MINIV2"
#elif defined(EF_VARIANT_KAKUTEF7V2)
#define USBD_PRODUCT_STRING "KAKUTEF7V2"
#elif defined(EF_VARIANT_KAKUTEF7V15)
...
#if defined(EF_VARIANT_KAKUTEF7V15) || defined(EF_VARIANT_KAKUTEF7V2) ||defined(EF_VARIANT_KAKUTEF7MINIV2)
