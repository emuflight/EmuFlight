...
#define USBD_PRODUCT_STRING                              "WIZZF7HD"
#define TARGET_MANUFACTURER_IDENTIFIER                   "WIZZ"
...
// timers
#define USABLE_TIMER_CHANNEL_COUNT                      8                       //updated timer count to compensate for Nf Motor 4
#define USED_TIMERS ( TIM_N(1) | TIM_N(3) | TIM_N(4) | TIM_N(8)   ) //update based on update CLRACINGF7 Target BF4.1+
