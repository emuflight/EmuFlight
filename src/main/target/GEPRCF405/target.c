...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM8, CH3, PC8,  TIM_USE_MOTOR, 0, 1), // S4
    DEF_TIM(TIM8, CH4, PC9,  TIM_USE_MOTOR, 0, 0), // S5
    DEF_TIM(TIM3, CH3, PB0,  TIM_USE_MOTOR, 0, 0), // S6 | TIM_USE_CAMERA_CONTROL
    DEF_TIM(TIM3, CH4, PB1,  TIM_USE_MOTOR|TIM_USE_LED, 0, 0), // S7 /LED_STRIP
