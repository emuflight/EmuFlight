...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM4, CH1, PB6, TIM_USE_MOTOR, 0, 0),   // S5
    DEF_TIM(TIM4, CH2, PB7, TIM_USE_MOTOR, 0, 0),   //S6
    DEF_TIM(TIM3, CH2, PC7, TIM_USE_MOTOR, 0, 0),   //S7
    DEF_TIM(TIM3, CH1, PC6, TIM_USE_MOTOR, 0, 0),   //S8

    DEF_TIM(TIM2, CH1, PA15, TIM_USE_LED, 0, 0),    //lED
    DEF_TIM(TIM1, CH1, PA8,  TIM_USE_ANY, 0, 0),    //CAMERA
