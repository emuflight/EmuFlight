 ...
 */
 ...
 void targetConfiguration(void) {
      pinioConfigMutable()->config[0] = PINIO_CONFIG_OUT_INVERTED | PINIO_CONFIG_MODE_OUT_PP;      //PINIO_CONFIG_OUT_INVERTED | PINIO_CONFIG_MODE_OUT_PP == 129
      pinioBoxConfigMutable()->permanentId[0] = BOXARM;      //BOXARM is 0
