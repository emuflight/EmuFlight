...
// FILO arrangement for motor assignments, Motor 1 starts at 2nd DECLARATION
    DEF_TIM(TIM4,  CH2,  PB7, TIM_USE_MOTOR,               0, 0), // D1-ST0                   MOTOR1
    DEF_TIM(TIM4,  CH1,  PB6, TIM_USE_MOTOR,               0, 0), // D1-ST3                   MOTOR2
    DEF_TIM(TIM3,  CH1,  PB4, TIM_USE_MOTOR,               0, 0), // D1-ST7                   MOTOR3
    ...
    DEF_TIM(TIM12, CH2,  PB15, TIM_USE_ANY,                 0, 0), // NONE  TIM4_UP_D1-ST6     MOTOR6
