...
#define USBD_PRODUCT_STRING                              "TALONF7V2DJIHD"
...
#define DEFAULT_VOLTAGE_METER_SCALE                 110                    //configurator tab voltage scale
...
// timers
#define USABLE_TIMER_CHANNEL_COUNT                      15                       //updated timer count to compensate for Nf Motor 4
