...
#define LED0_PIN                PB5
#if defined(EF_VARIANT_PODIUMF4)
#define LED1_PIN                PB4
#define LED2_PIN                PB6
#endif

// Disable LED1, conflicts with AirbotF4/Flip32F4 beeper
#if defined(EF_VARIANT_AIRBOTF4) || defined(EF_VARIANT_AIRBOTF4SD)
#define USE_BEEPER
...
#if defined(EF_VARIANT_AIRBOTF4SD)
...
#if defined(EF_VARIANT_REVO) || defined(EF_VARIANT_ELINF405)
#define USE_UART4
