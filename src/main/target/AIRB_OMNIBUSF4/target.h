...
#if defined(AIRB_OMNIBUSF4SD)
#define TARGET_BOARD_IDENTIFIER "OBSD"
#elif defined(LMNR_LUXF4OSD)
#define TARGET_BOARD_IDENTIFIER "LUX4"
#elif defined(DYST_DYSF4PRO)
#define TARGET_BOARD_IDENTIFIER "DYS4"
#elif defined(FPVM_XRACERF4)
#define TARGET_BOARD_IDENTIFIER "XRF4"
#elif defined(EACH_EXUAVF4PRO)
#define TARGET_BOARD_IDENTIFIER "EXF4"
#elif defined(KLEE_SYNERGYF4)
...
#if defined(AIRB_OMNIBUSF4SD) || defined(DYST_DYSF4PRO)
#define ENABLE_DSHOT_DMAR       true
#endif

#ifdef AIRB_OMNIBUSF4SD
...
#if defined(AORB_OMNIBUSF4SD)
#define GYRO_MPU6000_ALIGN       CW270_DEG
#define ACC_MPU6000_ALIGN        CW270_DEG
#elif defined(FPVM_XRACERF4) || defined(EACH_EXUAVF4PRO)
...
#if defined (AIRB_OMNIBUSF4SD) || defined(OMNIBUSF4BASE)
...
#if !defined(KLEE_SYNERGYF4) //No mag sensor on SYNERGYF4
#define USE_MAG
...
#if !defined(KLEE_SYNERGYF4) //No baro sensor on SYNERGYF4
#define USE_BARO
#if defined(AIRB_OMNIBUSF4SD)
...
#if defined(AIRB_OMNIBUSF4SD) || defined(LMNR_LUXF4OSD)
...
#if defined(OMNIBUSF4BASE) || defined(AIRB_OMNIBUSF4SD)
...
#if defined(AIRB_OMNIBUSF4SD) || defined(EACH_EXUAVF4PRO)
