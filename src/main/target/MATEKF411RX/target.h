...
#if defined(EF_VARIANT_CRAZYBEEF4FS) || defined(EF_VARIANT_CRAZYBEEF4FR) || defined(EF_VARIANT_CRAZYBEEF4DX)
...
#if defined(EF_VARIANT_CRAZYBEEF4FS)
...
#elif defined(EF_VARIANT_CRAZYBEEF4FR)
#define USE_LED_STRIP
#define USE_RX_SPI
#define RX_SPI_INSTANCE         SPI3
