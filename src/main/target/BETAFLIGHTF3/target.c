...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    // Motors 1-4
    DEF_TIM(TIM16, CH1,  PA6, TIM_USE_MOTOR,               0), // PWM1 UP(1,6) 1/3
    DEF_TIM(TIM8, CH1N,  PA7, TIM_USE_MOTOR,               0), // PWM2 UP(2,1) 1/1:7
    DEF_TIM(TIM8,  CH2,  PB8, TIM_USE_MOTOR,               0), // PWM3 UP(2,1) 1/5
    DEF_TIM(TIM17,  CH1,  PB9, TIM_USE_MOTOR,               0), // PWM4 UP(1,7) 2/1
