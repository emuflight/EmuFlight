...
#define CURRENT_METER_SCALE_DEFAULT        350                    // 3.3/120A  = 25mv/A
...
#define USED_TIMERS ( TIM_N(1) | TIM_N(2) | TIM_N(3) | TIM_N(4)   ) //update based on update CLRACINGF7 Target BF4.1+
