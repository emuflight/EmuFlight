...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE("spa_rate_p", "%d",                      currentControlRateProfile->dynSetpP);
        BLACKBOX_PRINT_HEADER_LINE("spa_rate_I", "%d",                      currentControlRateProfile->dynSetpI);
        BLACKBOX_PRINT_HEADER_LINE("spa_rate_D", "%d",                      currentControlRateProfile->dynSetpD);
