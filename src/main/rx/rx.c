...
// Even if the RX link is down, return true from the checker this many us to ensure background RX processing can be done
#define RX_CHECK_NO_RX_DATA_US 10000
