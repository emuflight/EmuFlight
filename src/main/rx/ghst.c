 ...
 * the Ghost receiver to Emuflight as and when they arrive. Emuflight itself is responsible for
...
STATIC_UNIT_TESTED uint8_t ghstFrameStatus(rxRuntimeConfig_t *rxRuntimeState)
{
