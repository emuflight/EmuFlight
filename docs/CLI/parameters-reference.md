...
> Source: `src/main/interface/settings.c` | Generated: 2026-07-01 | Commit: `ad0d646770` | Firmware: `0.3.2` | MSP: `0.1.49`
...
| `imuf_sharpness` | uint16 | master | `0` – `16000` |
...
| `dynamic_gyro_notch_max_hz` | uint16 | master | `600` – `1000` |
...
| `show_rate_dynamics` | uint8 | master | `OFF`, `ON` |
...
| `osd_lq_format` | uint8 | master | `TBS`, `MODE`, `FREQ` |
