...
> Source: `src/main/interface/settings.c` | Generated: 2026-07-01 | Commit: `0aa7f1cccd` | Firmware: `0.2.53` | MSP: `0.1.46`
...
| `imuf_sharpness` | uint16 | master | `1` – `16000` |
| `imuf_roll_q` | uint16 | master | `0` – `16000` |
| `imuf_pitch_q` | uint16 | master | `0` – `16000` |
| `imuf_yaw_q` | uint16 | master | `0` – `16000` |
| `imuf_w` | uint16 | master | `3` – `512` |
...
| Parameter | Type | Scope | Range / Values |
|-----------|------|-------|----------------|
| `rx_spi_protocol` | uint8 | master | `V202_250K`, `V202_1M`, `SYMA_X`, `SYMA_X5C`, `CX10`, `CX10A`, `H8_3D`, `INAV`, `FRSKY_D`, `FRSKY_X`, `FLYSKY`, `FLYSKY_2A`, `KN`, `SFHSS` |
...
| `vbat_comp_throttle_level` | uint8 | rate | `0` – `100` |
| `vbat_comp_pid_level` | uint8 | rate | `0` – `100` |
...
| `smart_dterm_smoothing_roll` | uint8 | profile | `0` – `250` |
| `smart_dterm_smoothing_pitch` | uint8 | profile | `0` – `250` |
| `smart_dterm_smoothing_yaw` | uint8 | profile | `0` – `250` |
| `witchcraft_roll` | uint8 | profile | `0` – `10` |
| `witchcraft_pitch` | uint8 | profile | `0` – `10` |
| `witchcraft_yaw` | uint8 | profile | `0` – `10` |
