...
> Source: `src/main/interface/settings.c` | Generated: 2026-07-01 | Commit: `c1bd326999` | Firmware: `0.2.0` | MSP: `0.1.43`
...
| `gyro_dyn_lpf` | uint16 | master | `0` – `16000` |
| `gyro_lowpass_type` | uint8 | master | `PT1`, `BIQUAD` |
| `gyro_lowpass_hz` | uint16 | master | `0` – `16000` |
| `gyro_lowpass2_type` | uint8 | master | `PT1`, `BIQUAD` |
| `gyro_lowpass2_hz` | uint16 | master | `0` – `16000` |
...
| `dyn_notch_quality` | uint8 | master | `1` – `70` |
| `dyn_notch_width_percent` | uint8 | master | `1` – `99` |
...
| `baro_tab_size` | uint8 | master | `0` – `BARO_SAMPLE_COUNT_MAX` |
...
| `rc_smoothing_derivative_hz` | uint8 | master | `0` – `UINT8_MAX` |
| `rc_smoothing_debug_axis` | uint8 | master | `ROLL`, `PITCH`, `YAW`, `THROTTLE` |
| `rc_smoothing_input_type` | uint8 | master | `PT1`, `BIQUAD` |
| `rc_smoothing_derivative_type` | uint8 | master | `OFF`, `PT1`, `BIQUAD` |
| `fpv_mix_degrees` | uint8 | master | `0` – `90` |
| `cinematic_yaw` | uint8 | master | `OFF`, `ON` |
| `max_aux_channels` | uint8 | master | `0` – `MAX_AUX_CHANNEL_COUNT` |
| `serialrx_provider` | uint8 | master | `SPEK1024`, `SPEK2048`, `SBUS`, `SUMD`, `SUMH`, `XB-B`, `XB-B-RJ01`, `IBUS`, `JETIEXBUS`, `CRSF`, `SRXL`, `CUSTOM`, `FPORT` |
...
| Parameter | Type | Scope | Range / Values |
|-----------|------|-------|----------------|
| `rx_spi_protocol` | uint8 | master | `V202_250K`, `V202_1M`, `SYMA_X`, `SYMA_X5C`, `CX10`, `CX10A`, `H8_3D`, `INAV`, `FRSKY_D`, `FRSKY_X`, `FLYSKY`, `FLYSKY_2A`, `KN` |
...
| `motor_pwm_protocol` | uint8 | master | `OFF`, `ONESHOT125`, `ONESHOT42`, `MULTISHOT`, `BRUSHED`, `DSHOT150`, `DSHOT300`, `DSHOT600`, `DSHOT1200`, `PROSHOT1000` |
...
| `rates_type` | uint8 | rate | `BETAFLIGHT`, `RACEFLIGHT` |
...
| Parameter | Type | Scope | Range / Values |
|-----------|------|-------|----------------|
| `dterm_lowpass_hz` | int16 | profile | `0` – `16000` |
| `dterm_lowpass2_hz` | int16 | profile | `0` – `16000` |
| `dterm_notch_hz` | uint16 | profile | `0` – `16000` |
| `dterm_notch_cutoff` | uint16 | profile | `0` – `16000` |
| `dterm_dyn_lpf` | uint16 | profile | `0` – `16000` |
| `vbat_pid_gain` | uint8 | profile | `OFF`, `ON` |
| `pid_at_min_throttle` | uint8 | profile | `OFF`, `ON` |
| `anti_gravity_mode` | uint8 | profile | `SMOOTH`, `STEP` |
| `anti_gravity_threshold` | uint16 | profile | `20` – `1000` |
| `anti_gravity_gain` | uint16 | profile | `1000` – `30000` |
| `feedforward_transition` | uint8 | profile | `0` – `100` |
| `spa_rate_p` | uint8 | profile | `0` – `250` |
| `spa_rate_i` | uint8 | profile | `0` – `250` |
| `spa_rate_d` | uint8 | profile | `0` – `250` |
| `spa_rate_p_yaw` | uint8 | profile | `0` – `250` |
| `spa_rate_i_yaw` | uint8 | profile | `0` – `250` |
| `spa_rate_d_yaw` | uint8 | profile | `0` – `250` |
...
| `iterm_relax` | uint8 | profile | `OFF`, `RP`, `RPY`, `RP_INC`, `RPY_INC` |
| `iterm_relax_type` | uint8 | profile | `GYRO`, `SETPOINT` |
| `iterm_relax_cutoff` | uint8 | profile | `1` – `100` |
| `iterm_windup` | uint8 | profile | `30` – `99` |
...
| `acro_trainer_angle_limit` | uint8 | profile | `10` – `80` |
| `acro_trainer_lookahead_ms` | uint16 | profile | `10` – `200` |
| `acro_trainer_debug_axis` | uint8 | profile | `ROLL`, `PITCH` |
| `acro_trainer_gain` | uint8 | profile | `25` – `255` |
| `feathered_pids` | uint8 | profile | `0` – `100` |
| `i_decay` | uint8 | profile | `1` – `10` |
| `r_weight` | uint8 | profile | `1` – `200` |
| `emu_boost` | uint16 | profile | `0` – `1000` |
| `emu_boost_yaw` | uint16 | profile | `0` – `1000` |
| `emu_boost_limit` | uint8 | profile | `0` – `250` |
| `emu_boost_limit_yaw` | uint8 | profile | `0` – `250` |
| `nfe_racermode` | uint8 | profile | `OFF`, `ON` |
| `p_pitch` | uint8 | profile | `0` – `200` |
| `i_pitch` | uint8 | profile | `0` – `200` |
| `d_pitch` | uint8 | profile | `0` – `200` |
| `f_pitch` | uint16 | profile | `0` – `2000` |
| `p_roll` | uint8 | profile | `0` – `200` |
| `i_roll` | uint8 | profile | `0` – `200` |
| `d_roll` | uint8 | profile | `0` – `200` |
| `f_roll` | uint16 | profile | `0` – `2000` |
| `p_yaw` | uint8 | profile | `0` – `200` |
| `i_yaw` | uint8 | profile | `0` – `200` |
| `d_yaw` | uint8 | profile | `0` – `200` |
| `f_yaw` | uint16 | profile | `0` – `2000` |
| `p_level` | uint8 | profile | `0` – `200` |
| `i_level` | uint8 | profile | `0` – `200` |
| `d_level` | uint8 | profile | `0` – `200` |
| `level_limit` | uint8 | profile | `10` – `90` |
| `horizon_tilt_effect` | uint8 | profile | `0` – `250` |
| `horizon_tilt_expert_mode` | uint8 | profile | `OFF`, `ON` |
| `abs_control_gain` | uint8 | profile | `0` – `20` |
| `abs_control_limit` | uint8 | profile | `10` – `255` |
| `abs_control_error_limit` | uint8 | profile | `1` – `45` |
| `use_integrated_yaw` | uint8 | profile | `OFF`, `ON` |
| `integrated_yaw_relax` | uint8 | profile | `0` – `255` |
...
| `osd_anti_gravity_pos` | uint16 | master | `0` – `OSD_POSCFG_MAX` |
...
| `debug_mode` | uint8 | master | `NONE`, `CYCLETIME`, `BATTERY`, `GYRO_FILTERED`, `ACCELEROMETER`, `PIDLOOP`, `GYRO_SCALED`, `RC_INTERPOLATION`, `ANGLERATE`, `ESC_SENSOR`, `SCHEDULER`, `STACK`, `ESC_SENSOR_RPM`, `ESC_SENSOR_TMP`, `ALTITUDE`, `FFT`, `FFT_TIME`, `FFT_FREQ`, `RX_FRSKY_SPI`, `GYRO_RAW`, `DUAL_GYRO`, `DUAL_GYRO_RAW`, `DUAL_GYRO_COMBINE`, `DUAL_GYRO_DIFF`, `MAX7456_SIGNAL`, `MAX7456_SPICLOCK`, `SBUS`, `FPORT`, `RANGEFINDER`, `RANGEFINDER_QUALITY`, `LIDAR_TF`, `CORE_TEMP`, `RUNAWAY_TAKEOFF`, `SDIO`, `CURRENT_SENSOR`, `USB`, `SMARTAUDIO`, `RTH`, `ITERM_RELAX`, `ACRO_TRAINER`, `RC_SMOOTHING`, `RX_SIGNAL_LOSS`, `RC_SMOOTHING_RATE`, `ANTI_GRAVITY`, `IMU`, `KALMAN` |
